...
1. Header Bar: Contains the title and buttons for folder selection, monitoring, and historical data.
2. Toolbar: Displays the selected folder and time window options.
3. Dashboard Container: Contains the main graphs and stats for pre-compression, compression, and ejection punches.

The Dashboard Container is further divided into:
- Punch Stats: Displays graphs for pre-compression, compression, and ejection punches.
- Punch Status: Displays the status of each punch.
- Cell Forces: Displays the live graph of load cell forces.

'''

# 1. Creates Header Bar
...
# 3. Creates Dashboard Container

# 3.1 Helper function to create the 3 graphs for punch stats
...
# 3.2 Helper function to create the eight punch status indicators
...
# 3.3 Helper function to create the live graph for load cell forces
...
# 4. The actual function that ties everything together
